...
const About = () => {
  return (
    <section id="about">
      ...
      <p className="about-paragraph">I started my Web Development career path in 2020 with an <a href="https://www.lighthouselabs.ca/en/intro-web-development-course?gclid=Cj0KCQjwj7CZBhDHARIsAPPWv3eqoPJ7V9hJQsoIZmU6g6tFOQELBQO_oZmCRSEci_MjC6HHY3TED6MaAjjnEALw_wcB">intro course</a> provided by <a href="https://www.lighthouselabs.ca/">Lighthouse Labs</a>
      . This sparked my interest in creating functional, attractive websites from the ground up. Upon completion I decided to upgrade
       ...
       Check out some of my projects on <a href="https://github.com/Moshe-jpg">Github</a>
      </div>
      <div>
